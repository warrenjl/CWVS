...
// A11_update
Rcpp::List A11_update(double A11_old, arma::mat x, arma::mat z, arma::vec off_set, arma::vec w, arma::vec gamma_l, arma::vec beta, arma::vec gamma, arma::vec delta1, double sigma2_A, double metrop_var_A11_trans, int acctot_A11_trans);
RcppExport SEXP _CWVS_A11_update(SEXP A11_oldSEXP, SEXP xSEXP, SEXP zSEXP, SEXP off_setSEXP, SEXP wSEXP, SEXP gamma_lSEXP, SEXP betaSEXP, SEXP gammaSEXP, SEXP delta1SEXP, SEXP sigma2_ASEXP, SEXP metrop_var_A11_transSEXP, SEXP acctot_A11_transSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(A11_update(A11_old, x, z, off_set, w, gamma_l, beta, gamma, delta1, sigma2_A, metrop_var_A11_trans, acctot_A11_trans));
...
// CWVS
Rcpp::List CWVS(int mcmc_samples, arma::vec y, arma::mat x, arma::mat z, int likelihood_indicator, double metrop_var_phi1_trans, double metrop_var_phi2_trans, double metrop_var_A11_trans, double metrop_var_A22_trans, Rcpp::Nullable<Rcpp::NumericVector> offset, Rcpp::Nullable<Rcpp::NumericVector> trials, Rcpp::Nullable<Rcpp::NumericVector> pair_id, Rcpp::Nullable<double> a_r_prior, Rcpp::Nullable<double> b_r_prior, Rcpp::Nullable<double> a_sigma2_epsilon_prior, Rcpp::Nullable<double> b_sigma2_epsilon_prior, Rcpp::Nullable<double> sigma2_beta_prior, Rcpp::Nullable<double> alpha_phi1_prior, Rcpp::Nullable<double> beta_phi1_prior, Rcpp::Nullable<double> alpha_phi2_prior, Rcpp::Nullable<double> beta_phi2_prior, Rcpp::Nullable<double> sigma2_A_prior, Rcpp::Nullable<double> r_init, Rcpp::Nullable<double> sigma2_epsilon_init, Rcpp::Nullable<Rcpp::NumericVector> beta_init, Rcpp::Nullable<Rcpp::NumericVector> gamma_init, Rcpp::Nullable<Rcpp::NumericVector> delta1_init, Rcpp::Nullable<Rcpp::NumericVector> delta2_init, Rcpp::Nullable<double> phi1_init, Rcpp::Nullable<double> phi2_init, Rcpp::Nullable<double> A11_init, Rcpp::Nullable<double> A22_init, Rcpp::Nullable<double> A21_init);
RcppExport SEXP _CWVS_CWVS(SEXP mcmc_samplesSEXP, SEXP ySEXP, SEXP xSEXP, SEXP zSEXP, SEXP likelihood_indicatorSEXP, SEXP metrop_var_phi1_transSEXP, SEXP metrop_var_phi2_transSEXP, SEXP metrop_var_A11_transSEXP, SEXP metrop_var_A22_transSEXP, SEXP offsetSEXP, SEXP trialsSEXP, SEXP pair_idSEXP, SEXP a_r_priorSEXP, SEXP b_r_priorSEXP, SEXP a_sigma2_epsilon_priorSEXP, SEXP b_sigma2_epsilon_priorSEXP, SEXP sigma2_beta_priorSEXP, SEXP alpha_phi1_priorSEXP, SEXP beta_phi1_priorSEXP, SEXP alpha_phi2_priorSEXP, SEXP beta_phi2_priorSEXP, SEXP sigma2_A_priorSEXP, SEXP r_initSEXP, SEXP sigma2_epsilon_initSEXP, SEXP beta_initSEXP, SEXP gamma_initSEXP, SEXP delta1_initSEXP, SEXP delta2_initSEXP, SEXP phi1_initSEXP, SEXP phi2_initSEXP, SEXP A11_initSEXP, SEXP A22_initSEXP, SEXP A21_initSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(CWVS(mcmc_samples, y, x, z, likelihood_indicator, metrop_var_phi1_trans, metrop_var_phi2_trans, metrop_var_A11_trans, metrop_var_A22_trans, offset, trials, pair_id, a_r_prior, b_r_prior, a_sigma2_epsilon_prior, b_sigma2_epsilon_prior, sigma2_beta_prior, alpha_phi1_prior, beta_phi1_prior, alpha_phi2_prior, beta_phi2_prior, sigma2_A_prior, r_init, sigma2_epsilon_init, beta_init, gamma_init, delta1_init, delta2_init, phi1_init, phi2_init, A11_init, A22_init, A21_init));
    return rcpp_result_gen;
END_RCPP
}
// beta_update
arma::vec beta_update(arma::mat x, arma::mat z, arma::vec off_set, double sigma2_beta, arma::vec w, arma::vec gamma_l, arma::vec gamma_old, double A11_old, arma::vec delta1_old);
RcppExport SEXP _CWVS_beta_update(SEXP xSEXP, SEXP zSEXP, SEXP off_setSEXP, SEXP sigma2_betaSEXP, SEXP wSEXP, SEXP gamma_lSEXP, SEXP gamma_oldSEXP, SEXP A11_oldSEXP, SEXP delta1_oldSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(beta_update(x, z, off_set, sigma2_beta, w, gamma_l, gamma_old, A11_old, delta1_old));
    return rcpp_result_gen;
END_RCPP
}
// delta1_update
arma::vec delta1_update(arma::mat x, arma::mat z, arma::vec off_set, arma::vec w, arma::vec gamma_l, arma::vec beta, arma::vec gamma, arma::vec gamma_star, double A11_old, double A21_old, double A22_old, arma::vec delta2_old, arma::mat corr_inv1);
RcppExport SEXP _CWVS_delta1_update(SEXP xSEXP, SEXP zSEXP, SEXP off_setSEXP, SEXP wSEXP, SEXP gamma_lSEXP, SEXP betaSEXP, SEXP gammaSEXP, SEXP gamma_starSEXP, SEXP A11_oldSEXP, SEXP A21_oldSEXP, SEXP A22_oldSEXP, SEXP delta2_oldSEXP, SEXP corr_inv1SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(delta1_update(x, z, off_set, w, gamma_l, beta, gamma, gamma_star, A11_old, A21_old, A22_old, delta2_old, corr_inv1));
    return rcpp_result_gen;
END_RCPP
}
// delta2_update
...
RcppExport SEXP _CWVS_exp_rs(SEXP aSEXP, SEXP bSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// gamma_update
arma::vec gamma_update(arma::mat x, arma::mat z, arma::vec off_set, arma::vec w, arma::vec gamma_l, arma::vec beta, arma::vec gamma_old, double A11_old, arma::vec delta1_old, double A21_old, double A22_old, arma::vec delta2_old);
RcppExport SEXP _CWVS_gamma_update(SEXP xSEXP, SEXP zSEXP, SEXP off_setSEXP, SEXP wSEXP, SEXP gamma_lSEXP, SEXP betaSEXP, SEXP gamma_oldSEXP, SEXP A11_oldSEXP, SEXP delta1_oldSEXP, SEXP A21_oldSEXP, SEXP A22_oldSEXP, SEXP delta2_oldSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type x(xSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type A22_old(A22_oldSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type delta2_old(delta2_oldSEXP);
    rcpp_result_gen = Rcpp::wrap(gamma_update(x, z, off_set, w, gamma_l, beta, gamma_old, A11_old, delta1_old, A21_old, A22_old, delta2_old));
    return rcpp_result_gen;
END_RCPP
}
// half_norm_rs
double half_norm_rs(double a, double b);
RcppExport SEXP _CWVS_half_norm_rs(SEXP aSEXP, SEXP bSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type a(aSEXP);
...
RcppExport SEXP _CWVS_norm_rs(SEXP aSEXP, SEXP bSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type a(aSEXP);
...
// r_update
int r_update(arma::vec y, arma::mat x, arma::mat z, arma::vec off_set, int a_r, int b_r, arma::vec beta, arma::vec gamma, double A11, arma::vec delta1);
RcppExport SEXP _CWVS_r_update(SEXP ySEXP, SEXP xSEXP, SEXP zSEXP, SEXP off_setSEXP, SEXP a_rSEXP, SEXP b_rSEXP, SEXP betaSEXP, SEXP gammaSEXP, SEXP A11SEXP, SEXP delta1SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< double >::type A11(A11SEXP);
    Rcpp::traits::input_parameter< arma::vec >::type delta1(delta1SEXP);
    rcpp_result_gen = Rcpp::wrap(r_update(y, x, z, off_set, a_r, b_r, beta, gamma, A11, delta1));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_pgdraw
...
RcppExport SEXP _CWVS_rnorm_trunc(SEXP muSEXP, SEXP sigmaSEXP, SEXP lowerSEXP, SEXP upperSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _CWVS_unif_rs(SEXP aSEXP, SEXP bSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type a(aSEXP);
...
// w_update
Rcpp::List w_update(arma::vec y, arma::mat x, arma::mat z, arma::vec off_set, arma::vec tri_als, int likelihood_indicator, int r, arma::vec beta_old, arma::vec gamma_old, double A11_old, arma::vec delta1_old);
RcppExport SEXP _CWVS_w_update(SEXP ySEXP, SEXP xSEXP, SEXP zSEXP, SEXP off_setSEXP, SEXP tri_alsSEXP, SEXP likelihood_indicatorSEXP, SEXP rSEXP, SEXP beta_oldSEXP, SEXP gamma_oldSEXP, SEXP A11_oldSEXP, SEXP delta1_oldSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< double >::type A11_old(A11_oldSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type delta1_old(delta1_oldSEXP);
    rcpp_result_gen = Rcpp::wrap(w_update(y, x, z, off_set, tri_als, likelihood_indicator, r, beta_old, gamma_old, A11_old, delta1_old));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_CWVS_A11_update", (DL_FUNC) &_CWVS_A11_update, 12},
    {"_CWVS_A21_update", (DL_FUNC) &_CWVS_A21_update, 5},
    {"_CWVS_A22_update", (DL_FUNC) &_CWVS_A22_update, 8},
    {"_CWVS_CWVS", (DL_FUNC) &_CWVS_CWVS, 33},
    {"_CWVS_beta_update", (DL_FUNC) &_CWVS_beta_update, 9},
    {"_CWVS_delta1_update", (DL_FUNC) &_CWVS_delta1_update, 13},
    {"_CWVS_delta2_update", (DL_FUNC) &_CWVS_delta2_update, 5},
    {"_CWVS_exp_rs", (DL_FUNC) &_CWVS_exp_rs, 2},
    ...
    {"_CWVS_w_update", (DL_FUNC) &_CWVS_w_update, 11},
    {NULL, NULL, 0}
};
