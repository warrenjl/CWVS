...
$\phi_j \stackrel{\text{iid}}{\sim}\text{Gamma}\left(\alpha_{\phi_j}, \beta_{\phi_j}\right),\ j=1,2;$
...
* $\delta_{jk} = 0$ for all $j$, $k$;

* $\sigma^2_{\theta} = 1.00$;

* $\sigma^2_{\eta} = 1.00$;

* $\phi_j = -\ln\left(0.05\right)/\left(m - 1\right)$ for all $j$;
