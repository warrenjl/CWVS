...
$Y_i|\boldsymbol{\beta}, \boldsymbol{\theta}, \sigma^2_{\epsilon} \stackrel{\text{ind}}{\sim} \text{Normal}\left(\textbf{x}_{i}^{\text{T}} \boldsymbol{\beta} + \sum_{j=1}^{m_{i}} \text{z}_{ij} \alpha\left(j\right), \sigma^2_{\epsilon}\right),\ i=1,...,n.$
