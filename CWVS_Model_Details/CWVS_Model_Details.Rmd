...
\begin{align*}
P\left(Y_{k1} = 1 | Y_{k0} + Y_{k1} = 1, \boldsymbol{\beta}, \boldsymbol{\alpha}\right) &= \frac{\exp\left\{\eta_{k1}\right\}}{\exp\left\{\eta_{k1}\right\} + \exp\left\{\eta_{k0}\right\}},\ k=1,...,K; \\
\eta_{ki} &= \textbf{x}_{ki}^{\text{T}} \boldsymbol{\beta} + \sum_{j=1}^{m_k} \text{z}_{kij}\,\alpha\left(j\right),\ i \in \{0,1\}.
\end{align*}
